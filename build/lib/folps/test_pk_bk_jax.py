...
# )
chain_name= f'chains/test_bk_jax_folpsD'
        ...
        for comp in ["ps",'bs']:  # handle PS and BS separately
            ...
            if comp=='ps':            
                emulator_filename = f'{base_dir}/Emulator_{comp}/{comp}_emu_{tracer}_z{z}_{kr_max}_Afull_{A_full_status}.npy'
                 ...
                 emulator_filename = f'{base_dir}_jax/Emulator_{comp}/{comp}_emu_{tracer}_z{z}_{kr_max}_{kr_b0_max}_{kr_b2_max}_Afull_{A_full_status}.npy'
