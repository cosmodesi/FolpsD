...
chain_name = (
    ...
    f"{f'_damping_{damping}' if damping != 'lor' else ''}_classpt_priors"
)
# chain_name= f'chains/test_mocks_std_folps_scheme_newcoev_alejandro_classpt_eft'
chain_name= f'chains/test_mocks_prior_doc_priors_bs_b3_width_sigma8_scaling'
chain_name = f'./Bk_prior_doc_scripts/TCM_tests/test_mocks_TCM_full_b3free_folpsD_pk'
chain_name = f'./Bk_prior_doc_scripts/new_jax_env_tests/chains_b0_kmax/Pk_only_vary_Bk_params'
# chain_name= f'chains/test_mocks_stdpriors_b3coev'
