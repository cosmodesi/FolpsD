...
chain_name = f'chains/MCMC-fs_abacus2gen_folpsv2_omegab_sims_fixed_ns_kmax_0.201_standard_bias_X_FoG_fixed'
if not set_emulator:
    chain_name += '_noemu'
#print(chain_name)
...
for tracer in tracers:
    ...
    print("X_FoG_p=",theory.params['X_FoG_p'].value)
...
def create_observable( #wmatrix_fn, covariance_fn,
    ...
    data, cov_arr, kr_pk = load_data_vector_and_covariance()
    print(data.shape,cov_arr.shape,kr_pk.shape)
...
if set_emulator:
    ...
    for i in range(len(theories)):
        emulator_filename = f'Emulator_test_sims_std/emu_-{tracers_str}_{str(tracers[i])}_new.npy'
