...
name=f"c_FolpsD_{tracer}_z{z_evaluation:.3f}_Pkmax-{k_max:.3f}_B000kmax-{k_max_b0:.3f}_B202kmax-{k_max_b2:.3f}_bsfree"
...
def Folps(h, omega_cdm, omega_b, logA_s, b1, b2, bs2, c1,c2,Pshot,Bshot, a_vir, a_vir_bk, k_ev):
    ...
    ps = generate_ps_baccoemu(h = h, ombh2 = omega_b, omch2 = omega_cdm, omnuh2 = omega_ncdm,
