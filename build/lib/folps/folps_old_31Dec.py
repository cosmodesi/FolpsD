...
class NonLinearPowerSpectrumCalculator:
    ...
    def _initialize_nonwiggle_power_spectrum(self, inputpkT, pknow=None, cosmo=None,k=None):
        ...
        if pknow is None:
            ...
            self.inputpkT_NW = extrapolate_pklin(k, pknow) #pknow[0], pknow[1]
...
class BispectrumCalculator:
    ...
    def Bisp_Sugiyama(self, f, bpars, k_pkl_pklnw, z_pk,
                      ...
                      m_bin=None, k_thy=None, do_binning=False, multipoles=['B000', 'B202'], do_interp=False,kout=None, renormalize=True):
