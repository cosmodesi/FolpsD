...
chain_name = f'/global/cfs/cdirs/desicollab/users/prakharb/folpsD_paper_chains/y1_chains/base/correct_measurements/MCMC-fs_klim_0-0.02-{k_max}_2-0.02-{k_max}-{tracers_str}-GCcomb_schoneberg2024-bbn_planck2018-ns10_{prior_basis}-prior_{model}_{pt_model}_Ano_int_freedom'
# chain_name= f'chains/test_folpsD_y1_prior_doc_priors_correct'
# if profiler:
profiler_chain_name = f'/global/cfs/cdirs/desicollab/users/prakharb/folpsD_paper_chains/y1_chains_profiler/base/Iminuit-fs_klim_0-0.02-{k_max}_2-0.02-{k_max}-{tracers_str}-GCcomb_schoneberg2024-bbn_planck2018-ns10_{prior_basis}-prior_{model}_{pt_model}_Ano_int_freedom'
...
for tracer in tracers:
    ...
    theory = FOLPSv2TracerPowerSpectrumMultipoles(tracer=tracer_name_alias,template=template, prior_basis=prior_basis,A_full=False, b3_coev=True, sigma8_fid=sigma8_fid,h_fid=fiducial.h)
    ...
    if prior_basis in ('physical', 'physical_prior_doc'):
        ...
        # theory.params['b3p'].update(prior = {'dist': 'norm', 'loc': 23/42*sigma8_fid, 'scale': 1})
