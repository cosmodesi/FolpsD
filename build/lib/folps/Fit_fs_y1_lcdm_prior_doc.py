...
chain_name = f'/global/cfs/cdirs/desicollab/users/prakharb/folpsD_paper_chains/y1_chains/base/correct_measurements/MCMC-fs_klim_0-0.02-{k_max}_2-0.02-{k_max}-{tracers_str}-GCcomb_schoneberg2024-bbn_planck2018-ns10_{prior_basis}-prior_{model}_{pt_model}_Ano_int_freedom_new'
...
for tracer in tracers:
    ...
    if prior_basis in ('physical', 'physical_prior_doc'):
        ...
        theory.params['b3p'].update(prior = {'dist': 'norm', 'loc': 23/42*sigma8_fid**3, 'scale': 1},fixed=False)
